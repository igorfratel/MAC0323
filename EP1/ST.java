...
public class ST {
    ...
    public ST() {
        arrayOfKeys = new String[1];
        arrayOfValues = new int[1];
    }
    ...
    public void put(String key) {
        ...
        if (arrayOfKeys.length == numberOfItems)
            resize(2*arrayOfKeys.length);
        arrayOfKeys[numberOfItems] = key;
        arrayOfValues[numberOfItems] = 1;
        numberOfItems++;
    }
    ...
    public void delete(String key) {
        ...
        for (int i = 0; i < numberOfItems; i++) {
            if (arrayOfKeys[i].equals(key)) {
                ...
                numberOfItems--;
                if (numberOfItems == arrayOfKeys.length/4)
                    resize(arrayOfKeys.length/2);
                break;
            }
        }
    }
    ...
    public String max() {
        ...
        if (isEmpty())
            throw new java.lang.NullPointerException("ST.max(): there is no such element");
        for (int i = 0; i < numberOfItems; i++)
            if (arrayOfValues[i] > arrayOfValues[indexOfMaxValue])
                indexOfMaxValue = i;
        return arrayOfKeys[indexOfMaxValue];
    }
    ...
    public String toString() {
        ...
        String results = "{";
        for (int i = 0; i < numberOfItems; i++) {
            results += "'"+arrayOfKeys[i]+"': "+arrayOfValues[i];
            if (i < numberOfItems - 1)
                results += " , ";
        }
        results += "}";
    ...
    private void resize(int k) {
        ...
        String[] newArrayOfKeys = new String[k];
        int[] newArrayOfValues = new int[k];
        for (int i = 0; i < numberOfItems; i++) {
    ...
    public String[] keys() {
        String[] resultArray = new String[numberOfItems];
        for (int i = 0; i < numberOfItems; i++)
            resultArray[i] = arrayOfKeys[i];
        return resultArray;
    }
